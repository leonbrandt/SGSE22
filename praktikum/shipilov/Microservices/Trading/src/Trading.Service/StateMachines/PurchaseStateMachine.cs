...
namespace Trading.Service.StateMachines
{
    public class PurchaseStateMachine : MassTransitStateMachine<PurchaseState>
    {
        ...
        public PurchaseStateMachine(MessageHub hub)
        {
            ...
            ConfigureFaulted();
            ConfigureCompleted();
            this.hub = hub; /* Any time that we make transition into some state (either faulted or completed),
            we will notify the client of the operation. So any terminal state shall be notified to the client. */
        }
