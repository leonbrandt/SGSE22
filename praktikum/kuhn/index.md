...
divers (m/w/d) verzichtet. Sämtliche Personenbezeichnungen gelten gleichermaßen für alle Geschlechter.

## Aufgabenstellung

Um die Basis für das Projekt zu legen, soll zuerst Design Thinking und User Centered Design ergründet werden. Mit diesem
Wissen kann dann ein Projektplan erstellt werden, nach dem die beiden Anwendungen entwickelt werden. Bei den beiden
Anwendungen handelt es sich um Apps. Abschließend soll eine qualitative Einschätzung der Vor- und Nachteile der beiden
Ansätze erfolgen.
...
Philosophie aus der verschiedene Methoden abgeleitet werden können. [Sim19]

Der Ansatz baut auf vier Grundpfeilern auf: Prinzipien, Rahmenbedingungen, Prozess und Team. Bestimmte Prinzipien müssen
...
Als Beispiel wird der Prozess des Hasso Plattner Instituts vorgestellt, der aus sechs Phasen besteht [[HPI]].
...
Er benutzt den Begriff User-Experience-Design-Prozess. Im Endeffekt wird damit
...
Horse Methode zum Einsatz kommen. Dabei werden die Ergebnisse in Paaren nach Bedürfnissen und Hürden eingeteilt, die
wiederum in
...
Anwendung implementiert werden. Mit dieser Version kann dann eine zweite Iteration des User Centered Designs
durchgeführt
werden. Dafür wird wieder das Feedback über einen Fragebogen eingeholt, um daraus neue Anforderungen zu bilden. Je nach
zeitlicher Verfügbarkeit können diese Anforderungen noch einmal umgesetzt werden.

Diese Iteration können beliebig weitergeführt werden, um eine Anwendung weiter zu optimieren. In [Abbildung 3] ist der
komplette Ablauf visualisiert.
...
eingeholt. ([Erlaubniserklärungen](#erlaubniserklärungen))
...
[Abbildung 21]
*Sinnvolle Orientierung an Spotifydesign (4:Sehr gut - 1:Schlecht)*
...
verschiedenen Kriterien betrachtet und gegenübergestellt.
...
Bezogen auf die in diesem Praktikum umgesetzten Projekte, war vor allem das User Centered Design ein voller Erfolg.
...
kann es helfen das Problem genauer zu verstehen und weitere Ideen einzubinden. Hier muss allerdings je nach Projekt
abgewogen werden, ob der entsprechende Aufwand den Nutzen Wert ist.

Vor allem für die Spotifyerweiterung hat das Design Thinking sehr gut funktioniert, da hier die Aufgabenstellung
deutlich offener war. Dadurch konnte der Prozess seine Stärken zeigen, komplett neue Ideen zu finden. Wäre hier direkt
mit einem Mockup gestartet, um User Centered Design durchzuführen, wären nicht so viele Ideen eingeflossen und Ideen für
mögliche Erweiterungen wären nicht aufgekommen. Für dieses Projekt war das Design Thinking also ein voller Erfolg.

Im Zusammenspiel haben die beiden Ansätze sehr gut funktioniert. Da es in der Startphase eines Projekts schwierig ist,
Feedback von Nutzern einzuholen, bietet Design Thinking hier eine gute Möglichkeit einen ersten Prototyp zu
entwickeln. Mithilfe von User Centered Design können hingegen Detailfragen zum Design geklärt werden, um die Anwendung
...
Die beiden Projekte sind bereits in einem fortgeschrittenen Zustand der Implementierung. Vor allem die Rettungsapp ist
fast produktivreif und soll weiterentwickelt werden, um sie zu veröffentlichen. Da bei beiden Anwendungen durch die
Nutzer bestätigt wurde, dass sie sinnvoll sind, soll die Spotifyerweiterung ebenfalls weiterentwickelt werden. Hier ist
als nächster Schritt die echte Anbindung an die Spotify-API sehr wichtig.

Für die nächsten Schritte soll weiter Feedback der Nutzer eingeholt werden, um das User Centered Design weiterzuführen.

## Anhang

### Erlaubniserklärungen

![](assets/ErlaubnisDBRD.png)

[Abbildung 24]
*Nutzungserlaubnis DBRD Algorithmen*

![](assets/ErlaubnisNUN.png)

[Abbildung 25]
*Nutzungserlaubnis NUN Algorithmen*
...
[Abbildung 7] - Rettungsapp: Wie gut hast du dich in dem Prototyp zurechtgefunden?(5:Sehr gut - 1:Schlecht)
...
[Abbildung 20] - Sinnvolle Orientierung an Spotifydesign (4:Sehr gut - 1:Schlecht)
...
[Abbildung 24] - Nutzungserlaubnis DBRD Algorithmen

[Abbildung 24]: https://mwithoeft.github.io/SGSE22/praktikum/kuhn/assets/ErlaubnisDBRD.png

[Abbildung 25] - Nutzungserlaubnis NUN Algorithmen

[Abbildung 25]: https://mwithoeft.github.io/SGSE22/praktikum/kuhn/assets/ErlaubnisNUN.png

### Literaturverzeichnis

[balsamiq] - balsamiq, Erstellung von Mockups, Einsichtnahme: 26.06.2022

[balsamiq]: https://balsamiq.com/

[DBRD] - Deutscher Berufsverband Rettungsdienst e.V., Einsichtnahme: 27.06.2022

[DBRD]: https://www.dbrd.de/index.php/aktuell/aktuelles/557-muster-algorithmen-2021-online

[Firebase] - Firebase Hosting, Einsichtnahme: 29.06.2022

[Firebase]: https://firebase.google.com/docs/hosting

[Flutter] - Flutter: Multiplattformframework, Einsichtnahme: 29.06.2022

[Flutter]: https://flutter.dev/

[Google Forms] - Google Forms, Umfragen erstellen, Einsichtnahme: 28.06.2022

[Google Forms]: https://www.google.de/intl/de/forms/about/

[HPI] Hasso-Plattner-Institut, Einsichtnahme: 30.06.2022

[HPI]: https://hpi.de/school-of-design-thinking/design-thinking/was-ist-design-thinking.html

[IPI] Tamara Prechter, Eine nutzerorientierte Prozessdatenbank dank des User Centered Design Process, 14.02.2018,
Einsichtnahme: 30.06.2022
...
[NUN] - Landesausschuss Rettungsdienst Niedersachsen, Einsichtnahme: 27.06.2022

[NUN]: https://lard-nds.de/download/nun-algorithmen-2022/

[Sim19] - Roman Simschek, Fabian Kaiser, Design Thinking, Innovation erfolgreich umsetzen, München 2019

[Spotify] - Spotify, Musikstreamingdienst, Einsichtnahme: 28.06.2022
