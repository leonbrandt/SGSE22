...
Das Kapitel befasst sich mit der Softwareevolution in der Softwareentwicklung. Die beschriebenen Inhalte stammen aus
...
eingeteilt. Der größte Unterschied liegt in der Unterscheidung einer Evolutions- und Servicephase. Der Ablauf
...
Die Basis für jede Evolution sind Änderungsvorschläge. Diese können unterschiedliche Beweggründe haben. So können
...
werden, um die Qualität der Software hochgehalten werden kann. Häufig funktioniert das aber nicht, was spätere
Änderungen
...
Altsysteme bestehen nicht nur aus der eigentlichen Software, sondern umfassen ebenfalls die Hardware, Bibliotheken,
anderes Softwareabhängigkeiten und Geschäftsprozesse. Deshalb spricht man von sozialtechnologischen Systemen. Diese
...
Performanceoptimierungen für alte Software häufig zu schwierig verständlichem Code, der Änderungen wieder schwieriger
macht.
...
Alternativen abgewägt wird. Diese Abwägung kann anhand diverser Merkmale passieren, wie der Nutzung des Systems. Hier
...
| Supportanforderungen |                                      Welcher lokale Support ist für die Hard- und Software nötig?                                       | 
...
Wartbarkeit gilt die Zeit, die für die Auswirkungsanalyse gebraucht wird. Dauert diese lange kann das daran liegen, dass
...
angepasst werden, um die Änderungen im Programm in den Daten widerzuspiegeln. In diesem Schritt bietet es sich an die
...
der Entscheidung, ob eine Umwandlung oder Neuentwicklung die richtige Lösung ist, sollte immer bedacht werden, dass eine
...
Das Refactoring ist vor allem in der agilen Entwicklung ein zentraler Bestandteil des Prozesses. Sowohl Refactoring als
auch die Softwareumwandlung haben zum Ziel die Verständlichkeit zu verbessern. Der Unterschied liegt darin, dass in der
...
vorbereitet zu sein. Wenn diese Änderungen nicht kommen, können solche Generalisierungen entfernt werden, um die
