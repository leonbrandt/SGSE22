...
2. Andere Standardtechnik erfüllt nicht zwingend die Anforderungen direkt, es sei denn sie wurden so geschrieben, dass sie die Standardtechnik schon im Vorfeld berücksichtigen. Aus diesem Grund muss Standardtechnik ausgewählt werden, die bereits ohne Änderungen nah an die Systemanforderungen herankommt. Eventuell werden auch die Anforderungen - wenn überhaupt möglich - an die Technik angepasst und nicht umgekehrt. ERP-Systeme fallen oft in diese Kategorie.
