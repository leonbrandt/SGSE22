...
*Abbildung 8* stellt den Prozess der Systementwicklung als Modell dar. Dabei wird ein Wasserfallmodell befolgt, welches im Bereich der Softwareentwicklung als nicht mehr zeitgemäß gilt. Prozesse auf einem hohen Level im Systems Engineering verfolgen dieses Modell jedoch. Hierbei handelt es sich um plansteuerte *(engl.: plan driven)* Prozesse, damit unterschiedliche Elemente des Systems von unterschiedlichen Vertragspartnern separat entwickelt werden können. Weil Änderungen hierbei schwierig, wenn nicht sogar unmögich sind, müssen die Anforderungen vor Beginn der Entwicklung komplett verstanden werden.
